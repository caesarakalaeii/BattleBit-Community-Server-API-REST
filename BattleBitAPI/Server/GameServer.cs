...
public class GameServer<TPlayer> : IDisposable where TPlayer : Player<TPlayer>
{
    ...
    public class Internal
    {
        ...
        // ---- Public Functions ---- 
        public void Set(Func<GameServer<TPlayer>, Internal, Stream, Task> func, TcpClient socket, IPAddress iP,
            int port, bool isPasswordProtected, string serverName, string gamemode, string map, MapSize mapSize,
            MapDayNight dayNight, int currentPlayers, int inQueuePlayers, int maxPlayers, string loadingScreenText,
