...
public class Player<TPlayer> where TPlayer : Player<TPlayer>
{
    ...
    public void SpawnPlayer(PlayerLoadout loadout, PlayerWearings wearings, Vector3 position, Vector3 lookDirection,
        PlayerStand stand, float spawnProtection)
    {
    ...
    public class Internal
    {
        ...
        public Internal()
        {
            _Modifications = new PlayerModifications<TPlayer>.mPlayerModifications();
